...
const ContactUs = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const response = await fetch('https://ecommerce-website-8dfa0-default-rtdb.firebaseio.com/userDetails.json',{
            method: "POST",
    ...
    <Container>
      <Form onSubmit={submitHandler}>
        ...
        <FormGroup className="mb-3">
          ...
          <FormControl ref={mobileNoRef} type="number" placeholder="enter mobile number" />
        </FormGroup>
